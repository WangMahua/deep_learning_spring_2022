...
if __name__ == '__main__':
    ...
    # train
    # model1 = ResNet18(num_class=5,feature_extract=False,use_pretrained=hyper_param_18['use_pretrained'])
    # optimizer = torch.optim.SGD(model1.parameters(), lr=hyper_param_18['Learning_Rate'], momentum=0.9)
    # Trainer1 = Trainer(model1,hyper_param_18,optimizer)
    # Trainer1.process()
    
    hyper_param_18['use_pretrained']=True 
    hyper_param_18['Epochs']=10
    model2 = ResNet18(num_class=5,feature_extract=False,use_pretrained=hyper_param_18['use_pretrained'])
    optimizer = torch.optim.SGD(model2.parameters(), lr=hyper_param_18['Learning_Rate'], momentum=0.9)
    Trainer2 = Trainer(model2,hyper_param_18,optimizer)
    Trainer2.process()

    # model3 = ResNet50(num_class=5,feature_extract=False,use_pretrained=hyper_param_50['use_pretrained'])
    # optimizer = torch.optim.SGD(model3.parameters(), lr=hyper_param_50['Learning_Rate'], momentum=0.9)
    # Trainer3 = Trainer(model3,hyper_param_50,optimizer)
    # Trainer3.process()

    # hyper_param_50['use_pretrained']=True 
    # model4 = ResNet50(num_class=5,feature_extract=False,use_pretrained=hyper_param_50['use_pretrained'])
    # optimizer = torch.optim.SGD(model4.parameters(), lr=hyper_param_50['Learning_Rate'], momentum=0.9)
    # Trainer4 = Trainer(model4,hyper_param_50,optimizer)
    # Trainer4.process()
